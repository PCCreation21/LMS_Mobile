  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => const RouteCollectionTrackingPage(),
      ),
      GoRoute(
        path: '/routes',
        builder: (context, state) => const RouteManagementPage(),
      ),
      GoRoute(
        path: '/loan-packages',
        builder: (context, state) => const LoanPackageManagementPage(),
      ),
      GoRoute(
        path: '/receipt/:id',
        builder: (context, state) {
